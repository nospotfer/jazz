...
const translations: Record<DashboardLanguage, Record<string, string>> = {
  en: {
    ...
    courseRecognitionPage: 'Course completion recognition',
    close: 'Close',
    userFallback: 'User',
  },
  pt: {
    ...
    inboxNewMessagePreview: 'Tienes mensajes no leídos en tu bandeja de entrada.',
    now: 'Agora',
    newItems: 'novas',
    ...
    courseRecognitionPage: 'Reconhecimento de conclusao do curso',
    close: 'Fechar',
  ...
  es: {
    ...
    courseRecognitionPage: 'Reconocimiento de finalizacion del curso',
    close: 'Cerrar',
  ...
  fr: {
    ...
    courseRecognitionPage: 'Reconnaissance de fin de cours',
    close: 'Fermer',
