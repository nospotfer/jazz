...
- The Complete button stays gray, disabled, and without check icon until the student watches at least 95% of the lesson. After reaching this threshold, the button becomes enabled in normal color and shows the check icon. For already completed lessons on revisit, the button remains green and clickable.
